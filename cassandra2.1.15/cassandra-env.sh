...
JVM_OPTS="$JVM_OPTS -Xloggc:/home/feiya/logs/cassandra/gc/gc.log"
...
if [ "$LOCAL_JMX" = "yes" ]; then
  ...
  JVM_OPTS="$JVM_OPTS -Dcom.sun.management.jmxremote.password.file=$CASSANDRA_HOME/conf/jmxremote.password"
  JVM_OPTS="$JVM_OPTS -Dcom.sun.management.jmxremote.access.file=$CASSANDRA_HOME/conf/jmxremote.access"
